...
const ALL_TESTS: TestCase[] = [
  {
    description: "writes self-documenting TypeScript",
    passes: true,
    duration: "4ms",
  },
  {
    description: "leaves PR reviews that don't start with 'nit:'",
    passes: true,
    duration: "8ms",
  },
  {
    description: "ships features behind feature flags",
    passes: true,
    duration: "12ms",
  },
  {
    description: "debugs RxJS streams without crying",
    passes: true,
    duration: "6ms",
  },
  {
    description: "respects the package-lock.json",
    passes: true,
    duration: "3ms",
  },
  {
    ...
    passes: false,
    duration: "30000ms",
    note: "Timeout: still refactoring the example",
  },
  {
    description: "closes browser tabs",
    passes: false,
    duration: "7ms",
    note: "FATAL ERROR: JavaScript heap out of memory",
  },
  {
    description: "estimates tickets accurately",
    passes: false,
    duration: "5ms",
    note: "Expected: 2 points, Received: 8 points",
  },
  {
    description: "resists rewriting legacy code",
    passes: false,
    duration: "9ms",
    note: "Uncaught RefactorError: it was right there",
  },
  {
    description: "uses the correct Git branch",
    passes: false,
    duration: "11ms",
    note: "fatal: committed to main (again)",
  },
];
